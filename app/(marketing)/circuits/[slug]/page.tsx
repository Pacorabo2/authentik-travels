    ...
    <main className="bg-white">
      ...
      <section className="container mx-auto py-20 px-6 grid grid-cols-1 lg:grid-cols-3 gap-16">
        <div className="lg:col-span-2 space-y-8">
          <div>
            <span className="text-amber-500 font-black uppercase tracking-widest text-xs">L&apos;Esprit Authentik</span>
            <h2 className="text-4xl font-bold text-slate-900 mt-2 italic leading-tight">{circuit.tagline}</h2>
          </div>
        ...
        <div className="bg-slate-50 p-10 rounded-[3rem] h-fit border border-slate-100 shadow-sm sticky top-24">
          <div className="space-y-6">
            <div className="flex justify-between items-center pb-6 border-b border-slate-200">
              <span className="font-bold text-slate-400 uppercase text-xs tracking-widest">Durée</span>
              <span className="font-black text-slate-900 text-xl">{circuit.duration} Jours</span>
            </div>
            
            <div className="space-y-1">
              <span className="font-bold text-slate-400 uppercase text-xs tracking-widest">À partir de</span>
              <p className="text-5xl font-black text-slate-900">{circuit.priceBase}€<span className="text-sm font-medium text-slate-400 ml-2">/ pers.</span></p>
            </div>
      ...
      <section className="bg-slate-50/50 py-24 border-t border-slate-100">
        <div className="container mx-auto px-6 text-center mb-12">
          ...
          <p className="text-slate-500 mt-4 max-w-xl mx-auto italic">
            Cet itinéraire est une base de travail. Nous l&apos;adaptons selon vos envies, votre rythme et votre budget.
          </p>
        </div>
