  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-center text-white">
        ...
        <p className="text-xl md:text-2xl mb-10 font-light opacity-90 text-balance">
          Parlez-nous de vos envies, de votre budget et de vos dates. Nous nous occupons de concevoir une aventure qui ne ressemble qu&apos;à vous.
        </p>
